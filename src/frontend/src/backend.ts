...
export class Backend implements backendInterface {
    ...
    async clearAllInquiries(): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.clearAllInquiries();
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async clearAllUsers(): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.clearAllUsers();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async forgotPassword(arg0: string, arg1: string): Promise<boolean> {
        if (this.processError) {
            try {
                const result = await this.actor.forgotPassword(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
